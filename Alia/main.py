...
class Assistant(QtWidgets.QMainWindow, interface.Ui_MainWindow, threading.Thread):
    ...
    def __init__(self):
        ...
        self.ndels = ['алия', 'алиа', 'элия', 'элиа', 'ладно', 'не могла бы ты', 'пожалуйста',
                      'текущее', 'сейчас']
    ...
    def opener(self, task):
        links = {
            ('youtube', 'ютуб', 'ютюб'): 'https://www.youtube.com/',
    ...
    def weather(self):
        ...
        owm = OWM('d2018174f92d6e1829a59f80dd1309b2')  # Ваш ключ с сайта open weather map
